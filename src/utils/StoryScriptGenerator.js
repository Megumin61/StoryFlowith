export class StoryScriptGenerator {
    ...
    extractActionFromDescription(description) {
        if (description.includes('管理')) return this.t.actions.manage;
        if (description.includes('整理')) return this.t.actions.organize;
        if (description.includes('识别')) return this.t.actions.recognize;
        return this.t.actions.operate;
    }

    extractLocationFromDescription(description) {
        if (description.includes('出租车')) return this.t.locations.taxi;
        if (description.includes('酒店')) return this.t.locations.hotel;
        if (description.includes('办公室')) return this.t.locations.office;
        if (description.includes('家')) return this.t.locations.home;
        return null;
    }
} 